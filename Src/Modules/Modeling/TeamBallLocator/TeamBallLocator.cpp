...
{
	// Since we haven't work extensively yet with free kicks and different play states we are going to disable resseting in this state.
	// TODO Must be changed when we utilize the rest of the states. <---------------------------
	...
	// Commenting this out because we don't have a game controller running just yet.
